...
public:
	CG_ExchangeManager();  // 객체 생성자
	~CG_ExchangeManager(); // 객체 파괴자
...
public:
	...
	inline CG_SendManager *GetSendMan() { return mp_send_man; }  // 전송용 객체의 주소를 얻는다.
	inline CG_RecvManager *GetRecvMan() { return mp_recv_man; }  // 수신용 객체의 주소를 얻는다.
...
public:
	...
	// IP를 사용하여 어떤 사용자인지 찾는다. 찾으면 사용자의 위치를 반환한다. 못찾으면 최대값 반환
...
public:
	...
	inline CG_SendManager *GetSendMan() { return &m_send_man; }  // 전송용 객체의 주소를 얻는다.
	inline CG_RecvManager *GetRecvMan() { return &m_recv_man; }  // 수신용 객체의 주소를 얻는다.
